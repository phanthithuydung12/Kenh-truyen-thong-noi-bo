...
const articleData = {
  ...
  content: `
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Hơn 1.000 phần quà Tết đã được cán bộ nhân viên NovaCore trao tận tay các hộ nghèo tại các tỉnh vùng cao phía Bắc. Đây là hoạt động thường niên nhằm mang đến một cái Tết ấm áp cho những hoàn cảnh khó khăn.
    </p>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Với tinh thần "Tết là để sẻ chia", đoàn thiện nguyện NovaCore đã vượt qua những con đường núi hiểm trở để đến từng hộ gia đình, trao gửi không chỉ những phần quà vật chất mà còn là sự quan tâm, yêu thương của tập thể Người NovaCore.
    </p>
    ...
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Hoạt động này không chỉ giúp đỡ những hoàn cảnh khó khăn mà còn thể hiện truyền thống tương thân, tương ái của dân tộc Việt Nam. Đây cũng là dịp để CBNV NovaCore thể hiện lòng nhân ái và trách nhiệm xã hội của mình đối với cộng đồng.
    </p>
  `
};
...
const comments = [
  ...
  },
  {
    ...
    avatar: "",
    date: "5 giờ trước",
    content: "Một hoạt động rất nhân văn của NovaCore. Chúc các anh chị em trong đoàn luôn khỏe mạnh!",
    likes: 32,
    replies: []
  },
  {
    ...
    avatar: "",
    date: "1 ngày trước",
    content: "Em rất tự hào là thành viên của NovaCore. Cảm ơn công ty đã tạo cơ hội để chúng em được sẻ chia.",
    likes: 28,
    replies: []
  }
];
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    { title: "Hiến máu nhân đạo: Giọt hồng NovaCore", date: "15/02/2025", likes: 320 },
                    { title: "Trồng cây xanh - Cho đời thêm xanh", date: "05/06/2024", likes: 280 },
                    { title: "NovaCore - Chặng đường 0đ 2025", date: "15/04/2025", likes: 156 },
                  ].map((item, index) => (
                    <Link 
                      key={index} 
                      href="#"
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    { title: "NovaCore - Chặng đường 0đ 2026", date: "15/04/2026", location: "Miền Tây" },
                    { title: "Mùa hè xanh NovaCore", date: "01/06/2026", location: "Phú Quý" },
                  ].map((item, index) => (
