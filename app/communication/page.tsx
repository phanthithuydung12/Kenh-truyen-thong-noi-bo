...
const featuredNews = {
  ...
  summary: "Hành trình 19 năm kiến tạo những giá trị bền vững và không ngừng đổi mới để phục vụ khách hàng tốt hơn mỗi ngày. Vietbank tự hào là người đồng hành tin cậy của hàng triệu khách hàng trên khắp cả nước.",
};
      ...
      <main className="max-w-[1200px] mx-auto w-full px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9 space-y-24">
            {activeSection === 'news' && (
              <section id="news" className="relative h-[450px] lg:h-[550px] w-full overflow-hidden rounded-[40px] shadow-xl border border-slate-200 dark:border-slate-800 bg-slate-900">
                <Image
                ...
                <div className="absolute bottom-16 left-0 right-0 px-4 lg:px-8">
