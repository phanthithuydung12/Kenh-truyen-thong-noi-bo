...
const articleData = {
  ...
  content: `
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Hành trình 19 năm kiến tạo những giá trị bền vững và không ngừng đổi mới để phục vụ khách hàng tốt hơn mỗi ngày. NovaCore tự hào là người đồng hành tin cậy của hàng triệu khách hàng trên khắp cả nước.
    </p>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Trong suốt 19 năm qua, NovaCore đã không ngừng phát triển và hoàn thiện, từ một công ty khởi nghiệp nhỏ với tầm nhìn lớn đã trở thành một trong những tập đoàn công nghệ hàng đầu Việt Nam. Chúng tôi luôn đặt khách hàng làm trung tâm của mọi quyết định và hoạt động kinh doanh.
    </p>
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 mt-8">Những dấu mốc quan trọng</h2>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Từ ngày thành lập đến nay, NovaCore đã đạt được nhiều thành tựu đáng kể: hệ thống chi nhánh mở rộng khắp cả nước, dịch vụ công nghệ số hiện đại, và nhiều giải thưởng uy tín trong ngành công nghệ.
    </p>
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 mt-8">Định hướng tương lai</h2>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Hướng tới tương lai, NovaCore tiếp tục đẩy mạnh chuyển đổi số, mang đến những trải nghiệm công ty công nghệ hiện đại và tiện lợi nhất cho khách hàng. Chúng tôi cam kết duy trì vị thế là doanh nghiệp công nghệ đáng tin cậy, luôn đồng hành cùng sự phát triển của khách hàng và cộng đồng.
    </p>
  `
};
...
const comments = [
  {
    ...
    avatar: "",
    date: "2 giờ trước",
    content: "Rất tự hào là một thành viên NovaCore! Chúc công ty ngày càng phát triển.",
    likes: 12,
    replies: [
      {
        id: 11,
  ...
  },
  {
    ...
    avatar: "",
    date: "5 giờ trước",
    content: "19 năm là một hành trình dài với nhiều thử thách. Chúc NovaCore tiếp tục thành công!",
    likes: 8,
    replies: []
  },
  {
    ...
    avatar: "",
    date: "1 ngày trước",
    content: "Nhân dịp kỷ niệm 19 năm, mong công ty có thêm nhiều chương trình ưu đãi cho khách hàng.",
    likes: 15,
    replies: []
  }
];
    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
      ...
      <main className="flex-1 bg-slate-50 dark:bg-background-dark/30">
        ...
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
          <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-3">
        ...
        {/* Article Content */}
        <article className="w-full max-w-7xl mx-auto px-6 md:px-8 py-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    { title: "Định hướng chiến lược số hóa công nghệ giai đoạn 2024-2026", date: "26/03/2026", views: 856 },
                    { title: "Thư chúc mừng của Tổng Giám đốc nhân ngày Phụ nữ Việt Nam", date: "25/03/2026", views: 1243 },
                    { title: "Kết quả cuộc thi 'Ý tưởng sáng tạo NovaCore 2026'", date: "24/03/2026", views: 967 },
                  ].map((item, index) => (
                    <Link 
                      key={index} 
                      href="#"
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    { title: "NovaCore đạt lợi nhuận kỷ lục năm 2025", views: 2341 },
                    { title: "Ra mắt ứng dụng NovaCore Smart Tech phiên bản mới", views: 1892 },
                    { title: "NovaCore tài trợ 5 tỷ đồng cho quỹ vắc-xin COVID-19", views: 1567 },
                  ].map((item, index) => (
                    <div key={index} className="flex items-start gap-3">
                      <span className="text-2xl font-black text-primary/50">0{index + 1}</span>
                      <div>
