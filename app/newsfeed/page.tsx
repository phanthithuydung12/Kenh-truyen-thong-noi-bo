...
const posts: Post[] = [
  {
    ...
    content: "📢 THÔNG BÁO QUAN TRỌNG\n\nKính gửi toàn thể CBNV,\n\nNgày 15/04/2026, NovaCore sẽ tổ chức Hội thảo chuyển đổi số với sự tham gia của các chuyên gia hàng đầu. Tất cả CBNV vui lòng đăng ký tham gia trước ngày 10/04/2026.\n\n📍 Địa điểm: Hội trường tầng 12, Tòa nhà Hội sở chính\n⏰ Thời gian: 14:00 - 17:00",
...
const trendingTopics = [
  ...
  { name: "#NovaCoreer's Story", posts: 28 },
              ...
              <div className="sticky top-24 space-y-4">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-800">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link href="/nguoi-novacore" className="block px-4 py-2 rounded-lg text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                      👥 Người NovaCore
                    </Link>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-800">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="group cursor-pointer">
                      ...
                      <h4 className="text-sm font-semibold text-slate-900 dark:text-white group-hover:text-primary transition-colors line-clamp-2">
                        Mùa hè xanh NovaCore 2026 - Tình nguyện viên
                      </h4>
