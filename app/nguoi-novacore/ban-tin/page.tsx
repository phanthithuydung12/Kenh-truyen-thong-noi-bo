...
const articleData = {
  ...
  title: "NovaCore đạt top 10 công ty công nghệ uy tín nhất Việt Nam 2024",
  category: "Thành tích",
  date: "16/03/2026",
  ...
  content: `
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Với những nỗ lực không ngừng trong việc nâng cao chất lượng dịch vụ và đổi mới công nghệ, NovaCore vinh dự được xếp hạng trong top 10 công ty công nghệ uy tín nhất Việt Nam năm 2024. Đây là sự công nhận xứng đáng cho những đóng góp và cam kết của công ty trong suốt thời gian qua.
    </p>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Theo công bố của Vietnam Report, NovaCore đã có bước tiến đáng kể trong các tiêu chí đánh giá bao gồm: chất lượng dịch vụ, năng lực tài chính, hoạt động truyền thông và trách nhiệm xã hội. Việc lọt vào top 10 khẳng định vị thế của NovaCore trong ngành công nghệ Việt Nam.
    </p>
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 mt-8">Những yếu tố dẫn đến thành công</h2>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Thành tích này đến từ sự nỗ lực của toàn thể CBNV NovaCore trong việc mang đến những sản phẩm, dịch vụ tốt nhất cho khách hàng. Đồng thời, tập đoàn đã không ngừng đổi mới công nghệ, cải tiến quy trình để nâng cao trải nghiệm dịch vụ.
    </p>
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 mt-8">Định hướng phát triển</h2>
    <p class="mb-6 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
      Hướng tới, NovaCore sẽ tiếp tục duy trì và phát huy những thành tựu đã đạt được, đồng thời phát triển thêm nhiều sản phẩm, dịch vụ mới để đáp ứng tốt hơn nhu cầu của khách hàng. Tập đoàn cam kết sẽ luôn đồng hành cùng sự phát triển của đất nước và đóng góp vào sự thịnh vượng của ngành công nghệ Việt Nam.
    </p>
  `
};
...
const comments = [
  ...
  },
  {
    ...
    date: "5 giờ trước",
    content: "Chúc mừng NovaCore! Hy vọng sẽ tiếp tục giữ vững vị thế này trong những năm tới.",
    likes: 8,
    replies: []
  }
];
        ...
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
          <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-3">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/nguoi-novacore" className="text-slate-500 hover:text-primary transition-colors">
                Người NovaCore
              </Link>
              <ChevronRight className="w-4 h-4 text-slate-400" />
              <Link href="/nguoi-novacore?tab=ban-tin-360" className="text-slate-500 hover:text-primary transition-colors">
                Bản tin 360°
              </Link>
              <ChevronRight className="w-4 h-4 text-slate-400" />
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { title: "Triển khai hệ thống Core Platform mới", category: "Công nghệ" },
                    { title: "Khai trương chi nhánh NovaCore tại Cần Thơ", category: "Mở rộng" },
                  ].map((item, index) => (
                    <Link 
                      key={index} 
                      href="#"
