...
const coreValues: CoreValue[] = [
  {
    ...
    description: "Làm việc với sự tận tâm, hết lòng vì sự phát triển của khách hàng và công ty. Mỗi hành động đều xuất phát từ trái tim và trách nhiệm.",
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary via-primary/90 to-primary/80 rounded-2xl p-8 text-center text-white">
        ...
        <p className="text-white/90 max-w-2xl mx-auto">
          ...
          của mỗi người NovaCore. Cùng nhau, chúng ta xây dựng một công ty công nghệ hiện đại, nhân văn và phát triển bền vững.
        </p>
      </div>
    </div>
  );
