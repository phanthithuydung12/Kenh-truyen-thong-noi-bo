...
const editions: Edition[] = [
    ...
    news: [
      {
        ...
        summary: "Với những nỗ lực không ngừng trong việc nâng cao chất lượng dịch vụ và đổi mới công nghệ, NovaCore vinh dự được xếp hạng trong top 10 công ty công nghệ uy tín nhất.",
        date: "16/03/2026",
        category: "Thành tích",
      },
      {
        ...
        summary: "NovaCore tổ chức khóa đào tạo kỹ năng lãnh đạo và quản lý cho 100+ cán bộ quản lý cấp trung tại resort 5 sao Đà Nẵng.",
        date: "14/03/2026",
        category: "Đào tạo",
      },
      {
        id: 3,
        title: "Triển khai hệ thống Core Platform mới thế hệ",
        summary: "Dự án nâng cấp hệ thống Core Platform với công nghệ hiện đại nhất, nâng cao trải nghiệm khách hàng và hiệu suất vận hành.",
        date: "10/03/2026",
        category: "Công nghệ",
      },
      {
        id: 4,
        title: "Khai trương chi nhánh NovaCore tại TP. Cần Thơ",
  ...
  },
  {
    ...
    news: [
      {
        id: 5,
        title: "NovaCore ra mắt tính năng QR Pay siêu tốc",
        summary: "Khách hàng NovaCore giờ đây có thể thanh toán bằng QR chỉ trong 3 giây với tính năng mới.",
        date: "28/02/2026",
        category: "Sản phẩm",
      },
      {
        ...
        summary: "NovaCore tổ chức hội nghị tổng kết năm 2025 và đề ra phương hướng năm 2026.",
        date: "25/02/2026",
        category: "Sự kiện",
      },
    ],
    ...
    news: [
      {
        ...
        summary: "NovaCore phát động thi đua cao điểm đầu năm mới với nhiều phần thưởng hấp dẫn cho CBNV.",
        date: "10/02/2026",
        category: "Thi đua",
      },
    ],
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-primary to-blue-600 rounded-xl p-6 text-white">
        <h2 className="text-xl font-black">
          Bản tin NovaCore 360° Kỳ {selectedEdition.editionNumber}
        </h2>
          ...
          >
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <Link href="/nguoi-novacore/ban-tin" className="mt-4 text-sm font-semibold text-primary hover:underline flex items-center gap-1">
                  Đọc thêm
