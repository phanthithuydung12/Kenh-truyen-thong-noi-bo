...
const events: Event[] = [
  ...
  {
    id: 3,
    title: "Hội thảo chuyển đổi số trong công nghệ",
    date: "10/03/2026",
    location: "Khách sạn Lotte, TP.HCM",
    description: "Chia sẻ kinh nghiệm và xu hướng công nghệ trong chuyển đổi số ngành công nghệ",
    attendees: 150,
    status: 'completed',
  },
  {
    ...
    date: "28/02/2026",
    location: "Auditorium NovaCore Tower",
...
export function SuKienCongNghe() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Các sự kiện và hoạt động nội bộ của NovaCore
        </p>
      </div>
