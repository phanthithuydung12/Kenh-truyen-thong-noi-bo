# NovaCore Portal - Kênh Thông Tin Nội Bộ NovaCore

Internal communication portal for NovaCore built with Next.js 15, React 19, and Tailwind CSS.
...
This is an internal project for NovaCore. Please follow the coding standards defined in `D:\demo\AGENTS.md`.

## License

Private - NovaCore Internal Use Only
